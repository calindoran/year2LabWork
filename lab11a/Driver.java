...
public class Driver
{
  	...
  	{ 
  		...
  		Shape 		shape;
  		Circle 		circle = new Circle("Circle One","Black", 10.0);
  		Rectangle	rectangle = new Rectangle("Rectangle One","White", 15.0, 20.0);
  		Cylinder	cylinder = new Cylinder("Cylinder One","Green", 6, 8);
  		Sphere		sphere = new Sphere("Sphere One","Blue", 77);
  		Triangle	triangle = new Triangle("Triangle One","Orange",10,12);
		...
		//print subclass object using references to abstract super class reference
  		...
  		shape = triangle;
  		System.out.println("\n---Using shape superclass reference for triangle "+shape.toString());
  		System.out.println("Trianlge area = "+shape.area());
